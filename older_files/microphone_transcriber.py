...
def print_partial_transcript(msg):
    ...
    #  response = analyze_excerpt(transcript)
    # Assuming the response contains a detected question and reasoning
    # if response.get("contains_question"):
    #     print(f"Detected Question: {response['detected_question']}")
    # else:
    #     print("No question detected in this segment.")
...
def print_transcript(msg):
    ...
    response = analyze_excerpt(transcript)
    print("      ")
    print("Response from Felix:", response)
    # Assuming the response contains a detected question and reasoning
    if response.get("has_interview_question"):
        print(f"Interview question': {response['interview_question']}")
    else:
        print("No question detected in this segment.")
